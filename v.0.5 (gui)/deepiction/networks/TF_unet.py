...
class TF_Unet:
  ...
  def __init__(self, inputshape, noutputs, nchannels_initial, npools, batchnorm, dropout, activation_final):
    ...
    p0 = Input(inputshape)  # DEBUG None instead 256
    ...
    outputs = Conv2D(noutputs, 3, padding="same")(u0) 
    outputs = Activation(activation_final)(outputs)
